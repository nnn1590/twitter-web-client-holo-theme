...
(function() {
    ...
    css.innerText = '@import url("https://fonts.googleapis.com/css?family=Kosugi+Maru&display=swap"); #global-actions > li > a > span.text {color: #ffffff; text-transform: uppercase; font-family: Roboto, "Kosugi Maru", "Noto Sans", "Noto Sans JP", "Noto Sans CJK JP", sans-serif;} #global-actions > li.holotab-line {border-left: 1px solid #333; height: 23px; margin-top: 11.5px;} #global-nav-home {border-left: none!important;} #global-actions > li > a:hover,  #global-actions > li > a:focus {background: #666;} #global-actions > li > a:active {background: #999;} .global-nav-inner {background: #000000; border-bottom: inset 2px #33b5e5;} body {background: linear-gradient(#000000, #272d33); background-attachment: fixed;}';
    css.type = 'text/css';
